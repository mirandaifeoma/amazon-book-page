      ...
      <section className='relative flex flex-wrap lg:h-screen lg:items-center bg-black login'>
        <div className='w-full px-4 py-12 lg:w-1/2 sm:px-6 lg:px-8 sm:py-16 lg:py-24 loginForm'>
          <div className='max-w-lg mx-auto text-center'>
            ...
            <p className='mt-4 text-gray-500'>
              Amazon symbol represents those who are paying a monthly fee to get
        ...
        <div className='relative w-full h-64 sm:h-96 lg:w-1/2 lg:h-full'>
          <img
            ...
            src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRFLYAKAIzvMqiwLJvw5MgyOsh0nx5-viPpKA&usqp=CAU'
            alt=''
          />
        </div>
      </section>
